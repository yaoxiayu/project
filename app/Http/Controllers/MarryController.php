...
class MarryController extends Controller
{
    ...
    {   
        ...
        $comment = Comment::all();
        return view('home.marry.shopuser',compact('shopuser','shopping','comment'));
    }
    ...
    {   
        ...
        return view('home.marry.shopping',compact('shopping','shopuser','comment'));

    }

    public function marry($id)
    {   
        ...
        return view('home.marry.index',compact('shopping','shopuser','order','comment','asd','tag'));
    }
