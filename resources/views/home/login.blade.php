...
<head>
    ...
    <script src="/static/js/staticloader_f1971d5.js"></script>
    <script>
    ...
    <link rel="stylesheet" type="text/css" href="/static/css/global-revision_ee57746.css" />
    <link rel="stylesheet" type="text/css" href="/static/css/common_d7fb37f.css" />
    <link rel="stylesheet" type="text/css" href="/static/css/user_0d53ca2.css" />
</head>

<body mon="page=index_new" class="gl-normal-screen">
    <script>
    F.context({
        'channel': 'other.baidu.com_wap||t10_bj_pc', // 
        'channel_content': '', // 
        'da_page': 'login', // 
...
<![endif]-->
                    ...
                    <div id="pass-phoenix-login" class="tang-pass-login-phoenix">
                        <div class="pass-phoenix-btn clearfix" id="pass_phoenix_btn">
                            <ul class="bd-acc-list">
                                <li class="bd-acc-qzone" data-dialog="1" data-acc="15" data-height="450" data-width="750"><a class="phoenix-btn-item" href="#" title="QQ帐号"></a></li>
                                <li class="bd-acc-tsina" data-dialog="1" data-acc="2" data-height="669" data-width="800"><a class="phoenix-btn-item" href="#" title="新浪微博"></a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="clear"></div>
                </div>
                <div id="TANGRAM__PSP_4__pass_b2c" style="display:none;"></div>
            </div>
        </div>
    </div>
    </div>
    <div class="w-footer-mini" alog-alias="bainuo-order-footermini" alog-group="bainuo-order-footermini">
        <div class="wrap">
            <div class="links">
                ...
                <a href="//www.nuomi.com/about/eula" class="link">用户协议</a><span>|</span> 客服电话：
                <span class="tel">400-9216-666</span>（每天9:00 - 22:00）</div>
            <div class="site-info">
                <span class="copyright">&copy;</span>2015&nbsp;nuomi.com&nbsp;<a href="http://www.miitbeian.gov.cn" class="link" target="_blank">京ICP证030173号</a> &nbsp;京公网安备11010802014106号
            </div>
        </div>
    </div>
    ...
    <script src="/static/js/jquery-1.10.2_d88366fd.js"></script>
</body>
<script type="text/javascript" src="/static/js/mod_e56bbba.js"></script>
<script type="text/javascript" src="/static/js/common_5e9cc9b.js"></script>
<script type="text/javascript" src="/static/js/login_c46c896.js"></script>
<script type="text/javascript">
...
! function() {
    F.context({
        "u": "https:\/\/passport.baidu.com\/v3\/login\/api\/auth?tpl=nuomi&return_type=5&u=https%3a%2f%2fm.nuomi.com%2fwebapp%2fuser%2fsetstoken%3fcallback%3dcb%26redirect%3d1&callback=cb"
    });
}();
! function() {
    require.async(['common:widget/ui/dialog/dialog.js'], function(Dialog) {
        $('#j-tttel').on('click', function() {
            Dialog.confirm({
                ...
                content: '<p>业务违规举报邮箱接受对团购业务违规方面的投诉和建议:<br />投诉邮箱：<a href="mailto:bdnm_jiancha@baidu.com" class="link">bdnm_jiancha@baidu.com</a><br />投诉电话：18618195132 <br/></p><p>以上邮箱和电话不接受用户咨询及商务合作。</p>',
    ...
    F.context('staticController').run(function(data, tools) {
        ...
        require.async(['common:widget/ui/usertrack/usertrack.js', 'common:widget/ui/sidlog/pclog.js', 'common:widget/ui/lazyload/lazyload.js', 'common:widget/ui/cookie/cookie.js', 'common:widget/ui/showtrack/showtrack.js', 'common:widget/ui/items_post/items_post.js'], function(usertrack, pclog, LazyLoad, Cookie, ShowTrack, itemsPost) {
            ...
            var sendPv = (function(smartyData) {
                ...
                // 
                { "staticData": { "page": "login" }, "dynamicData": { "logInfoExt": [] } }
            );
...
<!--33470855660997115658090713-->
<script>
var _trace_page_logid = 3347085566;
</script>