  ...
  <div class="tpl-block">
      <div class="am-g">
          <div class="tpl-form-body tpl-form-line">
              <form class=" tpl-form-line-form" method="post" action="/business/shopping/store" enctype="multipart/form-data">
                  ...
                  <div class="am-form-group">
                      ...
                      <div class="am-u-sm-9">
                          <input type="text" name="price" class="tpl-form-input" placeholder="" style="border-bottom-color: rgb(194, 202, 216);">
                      </div>
                  </div>
                 ...
                 <div class="am-form-group">
                      ...
                      <div class="am-u-sm-9">
                          <div class="am-form-group am-form-file">
                              ...
                              <input id="B" type="file" name="img" onchange="showPreview(this)" style="display:none;"/>
                              <img id="portrait" src="" width="200" height="200" style="display:none;" />
