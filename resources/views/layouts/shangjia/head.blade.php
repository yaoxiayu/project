        ...
        <ul class="nav pull-right">
            ...
            <li class="dropdown hidden-phone">
                ...
                <ul class="dropdown-menu messages">
                    ...
                    <li>
                        <a href="#">
                                        <span class="avatar"><img src="/business/img/avatar.jpg" alt="Avatar" /></span>
                                        <span class="header">
                                            <span class="from">
                                                ?ukasz Holeczek
                                             </span>
                    ...
                    <li>
                        <a href="#">
                                        <span class="avatar"><img src="/business/img/avatar2.jpg" alt="Avatar" /></span>
                                        <span class="header">
                                            <span class="from">
                                                Megan Abott
                                             </span>
                    ...
                    <li>
                        <a href="#">
                                        <span class="avatar"><img src="/business/img/avatar3.jpg" alt="Avatar" /></span>
                                        <span class="header">
                                            <span class="from">
                                                Kate Ross
                                             </span>
                    ...
                    <li>
                        <a href="#">
                                        <span class="avatar"><img src="/business/img/avatar4.jpg" alt="Avatar" /></span>
                                        <span class="header">
                                            <span class="from">
                                                Julie Blank
                                             </span>
                    ...
                    <li>
                        <a href="#">
                                        <span class="avatar"><img src="/business/img/avatar5.jpg" alt="Avatar" /></span>
                                        <span class="header">
                                            <span class="from">
                                                Jane Sanders
                                             </span>
