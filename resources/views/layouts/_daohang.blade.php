...
<meta name="renderer" content="webkit">
<meta name="baidu_ssp_verify" content="8541ea43669332b498d0d46a88e31c5c">
<script>var F = {};(function () {var b = {};F.context = function(p, r) {var q = arguments.length;if (q > 1) {b[p] = r} else {if (q == 1) {if (typeof p == "object") {for (var o in p) {if (p.hasOwnProperty(o)) {b[o] = p[o]}}} else {return b[p];}}}};})();</script>
...
<script>var _hmt = _hmt || [];F.context('tongji_hm',{init: (function() {return function (rtTag) {rtTag && _hmt.push(['_trackRTEvent', rtTag]);var hm = document.createElement('script');hm.src = '//hm.baidu.com/hm.js?a028c07bf31ffce4b2d21dd85b0b8907';var s = document.getElementsByTagName('script')[0];s.parentNode.insertBefore(hm, s);}})()});F.context('tongji_hm').init();</script>
<link rel="stylesheet" type="text/css" href="/home/static/css/global-revision_ee57746.css"/><link rel="stylesheet" type="text/css" href="/home/static/css/common_d7fb37f.css"/><link rel="stylesheet" type="text/css" href="/home/static/css/header_8e018e5.css"/><link rel="stylesheet" type="text/css" href="/home/static/css/index_a4c176c.css"/><link rel="stylesheet" type="text/css" href="/home/static/css/list_a00e520.css"/></head>
    ...
    <div class="header-bar static-hook-real static-hook-id-1" mon="area=navigation" id="header-bar">
        <div class="header-inner clearfix flexible ">
            ...
            <ul class="right-util first-level">
                <li><a href="#" class="pad-right" mon="element=my_order">个人中心</a></li>
...
<div class="header-bar static-hook-real static-hook-id-1" mon="area=navigation" id="header-bar"><div class="header-inner clearfix flexible "><ul class="left-city first-level" id="j-ucLoginList"><li class="welcome-text"><span class="welcome-tag" id="j-welcomeTag">Hi，欢迎来到百度糯米</span></li><li class="login"><a href="//www.nuomi.com/pclogin/main/loginpage" id="j-barLoginBtn" class="pad-left" mon="element=login">请登录</a></li><li class="reg"><a href="//passport.baidu.com/v2/?reg&tpl=nuomi&color=pink" id="j-barRegBtn"  class="pad-left" mon="element=register">免费注册</a></li><li class="logout"><a id="j-logout" href="https://passport.baidu.com/?logout"  class="pad-left" mon="element=logout">退出</a></li></ul><ul class="right-util first-level"><li><a href="//www.nuomi.com/uc/order/order?status=all&_=1536236659" class="pad-right" mon="element=my_order">个人中心</a></li><li id ="j-visitedArea" class="recent-view"><a href="#" class="pad-right" mon="element=recent_view"><span class="j-visitedArea-title">最近浏览</span><span class="arrow-down-logo"></span></a><span class="sep-lines"></span><div class="header-dropmenu items" id="j-visitedContainer"><div class="drop-block"></div><div class="loading">数据载入中...</div></div></li><li class="qr-code j-bar-dropdown"><a href="//d.nuomi.com/?1009764s" class="pad-left pad-right" target="_blank">糯米APP<span class="arrow-down-logo"></span></a><div class="header-dropmenu"><div class="drop-block"></div><a class="img" href="//d.nuomi.com/?1009764s" target="_blank">二维码</a></div></li><li class="j-bar-dropdown"><a href="#" class="pad-right"><span>我是商家</span><span class="arrow-down-logo"></span></a><span class="sep-lines"></span><div class="merchant-list header-dropmenu"><div class="drop-block"></div><a href="http://y.nuomi.com" class="link" target="_blank">商户中心</a><a href="https://mct.y.nuomi.com/sc/pc/guide/guideFlow?page=true" class="link" target="_blank">我想合作</a></div></li><li><a href="//www.nuomi.com/help" class="pad-left" mon="element=help_center">帮助中心</a></li><li><a href="//www.nuomi.com/pcindex/about/foodsafe " class="pad-left" mon="element=help_foodsafe">食品安全</a></li></ul></div></div>
<script type="text/javascript">

		F.context("page_name", "index_new"); // 
		F.context("coupon_url", "//www.nuomi.com/uc/giftcard/find?status=1"); // 
	</script>
<div class="search-bar clearfix flexible static-hook-real static-hook-id-2" mon="area=searchTop"><div class="logo-area"><a href="//www.nuomi.com" class="logo" mon="element=logo" title="百度糯米"><img class="fix-new-logo" src="/home/static/picture/re-logo_7c90a10.png"></a><div class="city-wrap"><span class="city-pos"></span><span>北京</span><span class="arrow-down-line"></span><div class="city-drop-down"><div class="drop-block"></div><h3>热门城市</h3><ul><li ><a href="//bj.nuomi.com">北京</a></li><li ><a href="//sh.nuomi.com">上海</a></li><li ><a href="//gz.nuomi.com">广州</a></li><li  class="no-right-margin" ><a href="//sz.nuomi.com">深圳</a></li><li ><a href="//tj.nuomi.com">天津</a></li><li ><a href="//hz.nuomi.com">杭州</a></li><li ><a href="//xa.nuomi.com">西安</a></li><li  class="no-right-margin" ><a href="//cd.nuomi.com">成都</a></li><li ><a href="//zz.nuomi.com">郑州</a></li><li ><a href="//xm.nuomi.com">厦门</a></li><li ><a href="//qd.nuomi.com">青岛</a></li><li  class="no-right-margin" ><a href="//ty.nuomi.com">太原</a></li><li ><a href="//cq.nuomi.com">重庆</a></li><li ><a href="//wh.nuomi.com">武汉</a></li><li ><a href="//nj.nuomi.com">南京</a></li><li  class="no-right-margin" ><a href="//sy.nuomi.com">沈阳</a></li><li ><a href="//jn.nuomi.com">济南</a></li><li ><a href="//hrb.nuomi.com">哈尔滨</a></li></ul><a href="//www.nuomi.com/changecity" class="link morelink">更多城市 &gt;</a></div></div></div><div class="search-area clearfix"><div data-ui-id="main-searcher" class="form-wrap clearfix"><form method="get" action="//bj.nuomi.com/search" id="j-searchForm" ><input type="text" id="j-searchInput" class="searchinput" name="k" value="" data-placeholder=""placeholder="搜索商家/地点" autocomplete="off" mon="element=search_input"/><div class="searchbtn-wrap"><input type="submit" class="searchbtn" id="j-searchBtn" value="" mon="element=search_button"/><span class="search-text">搜&nbsp;索</span><div class="btn-shadow"></div></div><input type="hidden" id="j-input-hidden" name="rid" value="5e11a75122df4436dce95dd5720e3270"></form></div><ul class="reco-list"><li><a href="//bj.nuomi.com/search?k=%E7%BE%8A%E8%9D%8E%E5%AD%90%E7%81%AB%E9%94%85" mon="element=hot_query&position=0">羊蝎子火锅</a></li><li><a href="//bj.nuomi.com/search?k=%E5%A4%A9%E8%99%B9%E5%95%86%E5%9C%BA" mon="element=hot_query&position=1">天虹商场</a></li><li><a href="//bj.nuomi.com/search?k=%E9%92%A2%E7%90%B4" mon="element=hot_query&position=2">钢琴</a></li><li><a href="//bj.nuomi.com/search?k=%E6%8E%A8%E6%8B%BF" mon="element=hot_query&position=3">推拿</a></li><li><a href="//bj.nuomi.com/search?k=%E8%88%9E%E8%B9%88" mon="element=hot_query&position=4">舞蹈</a></li></ul></div><input type="hidden" id="j-input-city-fix" value="bj"><div class="utils clearfix"><a href="//www.nuomi.com/pcindex/about/promise" mon="element=just_retire" target="_blank"><div class="util-item refund"><div class="u-icon refund"><div class="drop-block"></div></div><div class="util-tip">未消费，随便退！</div></div><div class="util-item mid"><div class="u-icon pei"><div class="drop-block"></div></div><div class="util-tip">消费不满意先行赔付！</div></div><div class="util-item last"><div class="u-icon money"><div class="drop-block"></div></div><div class="util-tip">过期自动退！</div></div></a></div></div><script type="text/template" id="autocomplete-template">
    <!--for:${data} as ${suggestion}, ${index}-->
    <div data-index="${index}" class="j-suggestion-item n-textbox-autocomplete-item" mon="area=sug&element=${suggestion.relword}">
        <span class="word">${suggestion.relword}</span>
        <span class="sug-count">约<em class="count">${suggestion.count}</em>个结果</span>
