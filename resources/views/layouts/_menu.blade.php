                ...
                <div id="menu_style" class="menu_style">
                    <ul class="nav nav-list" id="nav_list">
                        ...
                        <li><a href="#" class="dropdown-toggle"><i class="icon-bookmark"></i><span class="menu-text"> 评价管理 </span><b class="arrow icon-angle-down"></b></a>
                            <ul class="submenu">
                                <li class="home"><a href="/comment" title="评价列表" class="iframeurl"><i class="icon-double-angle-right"></i>评价列表</a></li>
                                <li class="home"><a href="/comment/create" title="评价列表" class="iframeurl"><i class="icon-double-angle-right"></i>评价添加</a></li>
                            </ul>
                        </li>
						<!-- 评价管理 end -->
